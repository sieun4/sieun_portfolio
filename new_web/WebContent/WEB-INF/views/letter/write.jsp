...
// 		= document.getElementById("j_userId").focus(); 	// focus() 함수 실행하면 그 곳으로 가서 커서가 깜빡임
	...
	$.ajax({						// ajax라는 함수 호출. {}안은 전부 매개변수
		...
		data: {'userId' : toId},	// 파라미터 {'이름', 변수(var)}
									// 바로 값을 넣을 땐 {'이름', '값'}
						...
						<form name="writeForm">
							...
							<c:if test="${msg != null }">
								${msg }
									...
									<!-- board write table -->
									<table summary="표 내용은 편지쓰기 박스입니다."
										...
										<tbody>
											<tr>
												<th class="tright"><label for="board_write_toId">받는 사람</label></th>
												<td class="tleft"><input type="text" name="toId" id="board_write_toId"
													title="받는 사람 ID 입력박스" class="input_100" /></td>
											</tr>
											<tr>
									...
									<div class="btn_bottom">
										<div class="btn_bottom_right">
											<input type="button" onclick="window.history.back()" value="취소" title="취소" />
