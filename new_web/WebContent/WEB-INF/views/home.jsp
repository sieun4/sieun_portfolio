...
<div id="page-wrapper">
	<header class="major"> 
			...
			<c:if test="${count != 0}">
				<h2><font color="violet">${sessionScope.nickname }(${sessionScope.userId })</font>님에게
...
<!-- Features 1 -->
				<div class="wrapper">
					<div class="container">
						<div class="row">
							<section class="6u 12u(narrower) feature">
								<div class="image-wrapper first">
									<a class="image featured first"><img src='<c:url value="/resources/images/photo_15.JPG"/>' alt="" /></a>
								</div>
								<header>
									<h2>받은 편지함</h2>
								</header>
								...
								<ul class="actions">
									<li><a href='<c:url value="/letter/list.do?toId=${sessionScope.userId}"/>' class="button" target="demoFrame">받은 편지함 바로가기</a></li>
								</ul>
							</section>
							<section class="6u 12u(narrower) feature">
								<div class="image-wrapper">
									<a class="image featured"><img src='<c:url value="/resources/images/photo_6.JPG"/>' alt="" /></a>
								</div>
								<header>
									<h2>자유게시판</h2>
								</header>
								...
								<ul class="actions">
									<li><a href='<c:url value="/free/list.do"/>' class="button" target="demoFrame">자유게시판 바로가기</a></li>
								</ul>
							</section>
						...
						원래 세로로 나오는게 아닌데 ㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠ
