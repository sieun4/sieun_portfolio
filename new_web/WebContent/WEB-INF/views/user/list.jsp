...
<script type="text/javascript"
	src="<c:url value="/resources/jqgrid/js/i18n/grid.locale-kr.js"/>"></script>
<script type="text/javascript"
								...
								.jqGrid(
										...
										}, // 하나의 Object
										{
											...
											beforeShowForm : function(form) {
												...
												$('tr#tr_nickname', form[0])
														.show(); // 'hidden한 데이터' 찾아서.보여주기
											...
											afterComplete : function(response,
												...
												case "success":
													...
													break;
												case "anomaly":
													alert("수정 중 오류(삭제이상)가 발생했습니다.");
													break;
												case "exception":
													alert("수정 중 오류(예외)가 발생했습니다.");
													break;
												}
												console
														.log('------------------------------');
										...
										{ // del
											...
											afterComplete : function(response,
													postdata) { // response : result와 같음
												console
														.log('delOption - afterComplete');
												console
												...
												case "success":
													...
													break;
												case "anomaly":
													alert("삭제 중 오류(삭제이상)가 발생했습니다.");
													break;
												case "exception":
													alert("삭제 중 오류(예외)가 발생했습니다.");
													break;
												}
												console
														.log('------------------------------');
						...
						<div class="board_area">
							...
							<div class="search">
								<select id="searchType" name="searchType" title="선택메뉴">
									...
									<option value="userId"
										<c:if test="${searchType == 'userId' }"> selected</c:if>>userId</option>
									<option value="userName"
										<c:if test="${searchType == 'userName' }"> selected</c:if>>userName</option>
									<option value="nickname"
										<c:if test="${searchType == 'nickname' }"> selected</c:if>>nickname</option>
