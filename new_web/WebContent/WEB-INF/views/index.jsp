		...
		<div id="header-wrapper">
			<div id="header" class="container">
				...
				<ul>
					<li><a href="#">편지함</a>
						<ul>
							<li><a href='<c:url value="/letter/list.do?toId=${sessionScope.userId}"/>' target="demoFrame">받은 편지함</a></li>
							<li><a href='<c:url value="/letter/list.do?fromId=${sessionScope.userId}"/>' target="demoFrame">보낸 편지함</a></li>
							<li><a href='<c:url value="/letter/goWrite.do"/>' target="demoFrame">편지 쓰기</a></li>
					...
					<li><a href='<c:url value="/free/list.do"/>' target="demoFrame">자유 게시판</a></li>
					<li class="break"><a href='<c:url value="/user/getInfo.do"/>' target="demoFrame">마이 페이지</a></li>
...
<c:if test="${sessionScope.userId != null }">
<c:out value="${sessionScope.nickname }"/>(<c:out value="${sessionScope.userId }"/>)님 반갑습니다! :D
</c:if>
</h2>
							</header>
			</section>
	...
	<div align="center">
	<br/>
	 <iframe id="demoFrame" name="demoFrame" style=" width: 803px; border-width: 0;" 
	 	cellpadding=0 cellspacing=0 onload="resize(this)"></iframe>
	 	<br/>
	 	</div>
		...
		<div id="footer-wrapper">
			<div id="footer" class="container">
				<header class="major">
				<h2>관리자에게 :)</h2>
				<p>오류를 발견하셨다면 제보해 주세요!<br/>
					ps. 디자인(폰트, 컬러 등)에 대한 지적은 잠시 넣어두어요....</p>
				</header>
				<div class="row">
				...
				이 페이지는 아래 항목을 이용하여 구현하였습니다.<br />
					Spring Framework 4.3.14.RELEASE<br />
					myBatis 3.4.1<br />
					jUnit 4.12<br />
				last update.... 2018. 04. 25	<br /><br />
				(이 버튼은 왜때문에 가운데로 안 가....)						
						</div>
						</div>
					<section id="hero" class="6u 12u(narrower)">
						 <a class="button">SIEUN</a>
					</section>
					</section>
				</div>
			</div>
